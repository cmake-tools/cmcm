...
function(missive_type)
  ...
  if(DEFINED ARG_STYLE)
    ...
    message(STATUS "FFFFFFF ${ARG_STYLE}")
  endif()

  if(DEFINED APPEND_STYLE)
    string(REPLACE "::" "_" APPEND_STYLE "${APPEND_STYLE}")
    message(STATUS "FFFFFFF ${APPEND_STYLE}")
  endif()

  if(DEFINED APPEND_STYLE_BEGIN)
    string(REPLACE "::" "_" APPEND_STYLE_BEGIN "${APPEND_STYLE_BEGIN}")
    message(STATUS "FFFFFFF ${ARG_STYLE}")
  endif()

  if(DEFINED APPEND_STYLE_END)
    string(REPLACE "::" "_" APPEND_STYLE_END "${APPEND_STYLE_END}")
    message(STATUS "FFFFFFF ${ARG_STYLE}")
  endif()
...
function(missive)
  ...
  if(NOT ${MISSIVE_TYPE_FOUND} STREQUAL "-1")
    ...
    if(CMAKE_VERSION VERSION_GREATER_EQUAL 3.21)
      message(${PARENT_TYPE} ${${APPEND_STYLE_BEGIN}} ${APPEND_BEGIN} ${DEFAULT_COLOR} ${${STYLE}} ${STRING_ARGV} ${DEFAULT_COLOR} ${${APPEND_STYLE_END}} ${APPEND_END}${Reset}${DEFAULT_COLOR})
    else()
      message(${PARENT_TYPE} ${${APPEND_STYLE_BEGIN}} ${APPEND_BEGIN} ${DEFAULT_COLOR} ${${STYLE}} ${STRING_ARGV} ${DEFAULT_COLOR} ${${APPEND_STYLE_END}} ${APPEND_END}${Reset}${DEFAULT_COLOR}${Reset})
    endif()
  else()
    message(${ARGV})
  endif()
